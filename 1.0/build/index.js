...
gallery/amapUtils/1.0/loader
gallery/amapUtils/1.0/mapWrapper
gallery/amapUtils/1.0/index

*/
KISSY.add('gallery/amapUtils/1.0/loader',function (S, Base) {
...
KISSY.add('gallery/amapUtils/1.0/mapWrapper',function (S, Node, Base, Loader) {
        'use strict';
        ...
        S.extend(MapWrapper, Base, {
                ...
                _init: function (centerData) {
                    ...
                    if (centerData && S.isNumber(centerData.lat) && S.isNumber(centerData.lng)) {
                        options.center = new AMap.LngLat(centerData.lng, centerData.lat);
                    } else if (options && S.isPlainObject(options.center) && S.isNumber(options.center.lat) && S.isNumber(options.center.lng)) {
                    ...
                    this.addListener('complete', function () {
                        ...
                        } else if (IS_GEOLOCATION_SUPPORTED && centerData && centerData.geolocation) {
 ...
 * @module amapUtils
 **/
KISSY.add('gallery/amapUtils/1.0/index',function (S, Loader, MapWrapper) {
    return {
        Loader: Loader,
        MapWrapper: MapWrapper
    };
}, {requires: ['./loader', './mapWrapper']});
